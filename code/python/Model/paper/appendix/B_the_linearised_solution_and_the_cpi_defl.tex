...
Two robustness exhibits that support the main-text results without being part
of the argument: the accuracy of the linearised (sequence-space) solution given
the discrete adoption choice, and the first-order welfare check on the nonlinear
transition.
...
rankings \citep{KimKim2003,BenignoWoodford2005}: the first-order term is
