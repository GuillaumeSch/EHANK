...
crisis. Green incumbents, fully insulated from the brown price ($\rho_g=0$), still
...
% [REVISION 2026-08-21: mechanism corrected. Old text claimed the prepared
% economy adopts LESS in the crisis; the ETS cross-section (Sec.~6.2) shows it
% adopts MORE (peak dD_G 15.0 vs 8.9pp). The dividend result is about welfare
% value, not switching volume. Reworded below -- flag for Boris.]
