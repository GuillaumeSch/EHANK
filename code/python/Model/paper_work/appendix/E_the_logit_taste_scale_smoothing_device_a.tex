...
below hold $\psi_g$ fixed at $\psi_g^*$ and let $D^G$ float: $\psi_g$ is dropped
from the steady-state unknowns and the $D^G$ residual from the targets (the same
configuration that builds the ex-ante ETS economy of
